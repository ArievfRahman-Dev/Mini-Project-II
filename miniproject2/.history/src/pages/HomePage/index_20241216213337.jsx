            ...
            {data.map((user) => (
              ...
              >
                ...
                <Link to={`/detail/${user.id}`}>
                  <button className=" mt-2 px-4 py-1 font-semibold  text-yellow-100 transition-colors bg-green-600 rounded-lg border border-black hover:bg-green-800 retro-font shadow-lg">
                    Detail User
                  </button>
                </Link>
              </div>
