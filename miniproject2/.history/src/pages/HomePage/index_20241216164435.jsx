...
export const HomePage = () => {
  ...
  const getData = async () => {
    try {
      ...
      setTotalPages(res.data.total_pages); // Menyimpan total halaman
    } catch (error) {
      console.log(error);
    }
  };
  ...
  // Memanggil fungsi untuk mengambil data ketika halaman berubah
  useEffect(() => {
    getData();
  }, [page]);
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center mb-4">
            <button
              onClick={handlePrev}
              disabled={page === 1}
              className="px-4 py-2 bg-green-600 text-white rounded-l-lg hover:bg-green-700"
            >
              Previous
            </button>
            <button
          ...
          {/* Menampilkan pengguna dalam grid dengan 3 pengguna per halaman */}
          ...
          {/* Menampilkan tombol Pagination lagi */}
