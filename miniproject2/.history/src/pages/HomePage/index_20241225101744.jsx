...
export const HomePage = () => {
  ...
  return (
    <div>
      <Navbar />
      <div id="home" className="min-h-screen py-8 bg-yellow-100">
        <div className="container px-4 mx-auto text-center lg:px-8">
          ...
          <a
            href="#people"
            className="px-6 py-3 text-lg text-white transition-all bg-green-800 rounded-full hover:bg-green-700 scroll-mt-24"
          >
            Explore People
          </a>
        </div>
        ...
        <div
          id="people"
          className="container px-4 mx-auto mt-16 lg:px-8 scroll-mt-24"
        >
          <h2 className="mb-8 text-3xl font-semibold text-center text-green-800">
            Our Featured People
          </h2>
