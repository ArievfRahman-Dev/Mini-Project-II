        ...
        <div id="contact" className="py-16 bg-yellow-100">
          <div className="container px-4 mx-auto lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {/* Email Section */}
              <div className="p-6 text-center bg-yellow-200 border-2 border-yellow-400 rounded-lg shadow-lg">
                <i className="mb-4 text-4xl text-green-800 ri-mail-line"></i>
                <h3 className="mb-2 text-xl font-semibold text-green-900">
                  Email Us
                </h3>
                <p className="mb-4 text-green-800">
                  Feel free to drop us an email, and we’ll respond as soon as
                  possible.
                </p>
                <a
                  href="mailto:ademaulana100499@outlook.com"
              ...
              {/* Phone Section */}
              <div className="p-6 text-center bg-yellow-200 border-2 border-yellow-400 rounded-lg shadow-lg">
                <i className="mb-4 text-4xl text-green-800 ri-phone-line"></i>
                <h3 className="mb-2 text-xl font-semibold text-green-900">
                  Call Us
                </h3>
                <p className="mb-4 text-green-800">
                  Prefer to talk directly? Call us for immediate assistance.
                </p>
              ...
              {/* Location Section */}
              <div className="p-6 text-center bg-yellow-200 border-2 border-yellow-400 rounded-lg shadow-lg">
                <i className="mb-4 text-4xl text-green-800 ri-map-pin-line"></i>
                <h3 className="mb-2 text-xl font-semibold text-green-900">
                  Visit Us
                </h3>
                <p className="mb-4 text-green-800">
                  Our office is open from Monday to Friday, 9 AM to 5 PM.
                </p>
            ...
            {/* Contact Form */}
            <div className="mt-16">
              <h3 className="mb-6 text-2xl font-semibold text-center text-green-800">
