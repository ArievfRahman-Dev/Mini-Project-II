      ...
      <div id="home" className="min-h-screen py-8 bg-yellow-100 scroll-mt-24">
        ...
        <div id="about" className="container px-4 mx-auto mt-16 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div>
              <img
                src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fleadchangegroup.com%2Fhow-do-you-influence-and-inspire-people%2F&psig=AOvVaw0LPTBktvhRovYi4AO8XFh3&ust=1735189622047000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCNiqtZyTwooDFQAAAAAdAAAAABAE"
                alt="About Us"
        ...
        <div id="contact" className="py-16 bg-yellow-100">
          <div className="container px-4 mx-auto text-center lg:px-8">
            <h2 className="mb-8 text-3xl font-semibold text-green-800">
              Contact Us
            </h2>
            <p className="mb-6 text-lg text-green-800">
