  ...
  return (
    <div>
      ...
      <div className="min-h-screen py-8 bg-yellow-100">
        ...
        <div id="people" className="container px-4 mx-auto mt-16 lg:px-8">
          <h2 className="mb-8 text-3xl font-semibold text-center text-green-800">
            Our Featured People
          </h2>
        ...
        <div id="contact" className="py-16 bg-yellow-100">
          <div className="container px-4 mx-auto text-center lg:px-8">
            ...
            <a className="px-6 py-3 text-lg text-white transition-all bg-green-800 rounded-full hover:bg-green-700">
              Send Us an Email
            </a>
          </div>
        </div>
