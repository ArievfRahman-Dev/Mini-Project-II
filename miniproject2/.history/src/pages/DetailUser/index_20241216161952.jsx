...
export const DetailUser = () => {
  const [data, setData] = useState({}); // Mulai dengan objek kosong
  const { id } = useParams();
  ...
  const getData = async () => {
    try {
      ...
      setData(res.data); // Simpan data yang diterima
    } catch (error) {
      console.log(error);
    }
  };
  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4 py-6">
        {/* Pastikan data dan data.data ada sebelum akses */}
        ...
        {/* Pastikan data.support ada sebelum akses */}
