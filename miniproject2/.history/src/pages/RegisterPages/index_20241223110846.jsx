      ...
      <div className="flex items-center justify-center flex-1 p-4">
        <div className="w-full max-w-md p-8 bg-yellow-200 border-2 border-green-800 shadow-lg rounded-xl">
          ...
          <form>
            ...
            <Button
              className={`w-full px-4 py-2 font-semibold text-yellow-100 rounded-lg shadow retro-font ${loading} focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-1`}
              disabled={loading}
