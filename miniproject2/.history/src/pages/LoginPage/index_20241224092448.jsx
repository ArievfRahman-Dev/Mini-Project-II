          ...
          <form>
            <div className="mb-4 relative">
              <input
                ...
                className="w-full px-4 py-2 pl-10 text-green-900 border-2 border-green-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400 bg-yellow-50"
              />
            ...
            <div className="mb-4 relative">
              ...
              <button
                ...
                className="absolute right-3 top-3 text-green-800 focus:outline-none"
              >
                <i
            ...
            <div className="mb-4 flex items-center">
              ...
              <label
                htmlFor="agreement"
                className="ml-2 text-green-900 text-sm"
              >
