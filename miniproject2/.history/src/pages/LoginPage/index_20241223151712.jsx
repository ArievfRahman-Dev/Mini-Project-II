...
export const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-yellow-100  opacity-60 bg-[repeating-radial-gradient(circle_at_0_0,_transparent_0,_#e5e5f7_10px),_repeating-linear-gradient(#444cf755,_#444cf7)]">
      <Navbar />
