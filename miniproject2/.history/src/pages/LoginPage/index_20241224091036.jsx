        ...
        <div className="w-full max-w-md p-8 bg-yellow-200 border-2 border-green-800 shadow-2xl opacity-90 rounded-xl">
          ...
          <form>
            <div className="mb-4 flex items-center">
              <i className="fas fa-user text-green-800 mr-3"></i>
              <input
            ...
            <div className="mb-4 flex items-center">
              <i className="fas fa-lock text-green-800 mr-3"></i>
              <input
          ...
          <div className="mt-6">
            <p className="mb-4 text-sm text-center text-green-900">
              Or login with
            </p>
            <div className="flex justify-center gap-4">
              <button className="flex items-center px-4 py-2 text-sm font-semibold text-yellow-100 bg-blue-600 rounded-lg shadow hover:bg-blue-800">
                <i className="fab fa-facebook mr-2"></i> Facebook
              </button>
              <button className="flex items-center px-4 py-2 text-sm font-semibold text-yellow-100 bg-red-600 rounded-lg shadow hover:bg-red-800">
