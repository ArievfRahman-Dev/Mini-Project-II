  ...
  return (
    <div className="flex flex-col min-h-screen bg-yellow-100 ">
      ...
      <div className="flex items-center justify-center flex-1 p-4">
        <div className="w-full max-w-md p-8 bg-yellow-200 border-2 border-green-800 shadow-lg rounded-xlbg-[#e5e5f7] opacity-60 bg-[repeating-radial-gradient(circle_at_0_0,_transparent_0,_#e5e5f7_10px),_repeating-linear-gradient(#444cf755,_#444cf7)] ">
