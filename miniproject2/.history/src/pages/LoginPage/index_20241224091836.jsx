...
export const LoginPage = () => {
  ...
  <div className="w-full max-w-md p-8 bg-yellow-200 border-2 border-green-800 shadow-2xl opacity-90 rounded-xl">
    ...
    <!-- Login ke Platform Lain -->
    <div className="mt-6 text-center">
      <p className="text-green-900">Login ke Platform Lain:</p>
      <div className="flex justify-center space-x-4 mt-2">
        <button
          className="w-10 h-10 bg-blue-600 text-white rounded-full flex items-center justify-center hover:bg-blue-800"
        >
          <i className="fab fa-facebook-f"></i>
        </button>
        <button
          className="w-10 h-10 bg-blue-400 text-white rounded-full flex items-center justify-center hover:bg-blue-600"
        >
          <i className="fab fa-twitter"></i>
        </button>
        <button
          className="w-10 h-10 bg-red-600 text-white rounded-full flex items-center justify-center hover:bg-red-800"
        >
