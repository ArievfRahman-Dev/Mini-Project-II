...
export const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-yellow-200 border-b-4 border-yellow-400 shadow-md">
      ...
      {isMenuOpen && (
        <div className="md:hidden flex flex-row justify-between mx-4 items-center py-3 bg-yellow-200">
          <Link
            to="/"
          ...
          {token ? (
            ...
            <Link
              to="/login"
              className="px-4 items-center py-2 font-semibold text-yellow-100 bg-green-600 rounded-lg hover:bg-green-800 retro-font shadow-lg mt-2"
              onClick={closeMenu}
            >
              Login
            </Link>
